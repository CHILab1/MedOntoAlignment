...
if __name__ == '__main__':
    ...
    df = pd.read_csv(f'{path}Results-{target_field}/{target_field}_results_mms.tsv', sep='\t', index_col=False)
    ...
    df_icd11 = pd.read_csv(f'{path}icd11-mms-sex.tsv', sep='\t')
    ...
    mpx_matches_df.to_csv(f'/home/isiragusa/DR_LLM/KG/icd11/Results-{target_field}/{target_field}_mpx_matches.tsv', sep='\t', index=False)